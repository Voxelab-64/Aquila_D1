...
// Limit Switches
//
#define X_MIN_PIN                           PA15   // pin 16
// #define X_MAX_PIN                           PC0   // pin 15 (Filament sensor on Alfawise setup)
#define Y_MIN_PIN                           PD4  // pin 9
// #define Y_MAX_PIN                           PC14  // pin 8 (Unused in stock Alfawise setup)
#define Z_MIN_PIN                           PB1   // pin 5 Standard Endstop or Z_Probe endstop function
...
//
  ...
  #define FIL_RUNOUT_PIN                    PA0   // XMAX plug on PCB used as filament runout sensor on Alfawise boards (inverting true)
#endif

//
// Steppers
//
#define X_ENABLE_PIN                        PE5   // pin 91
#define X_STEP_PIN                          PE4   // pin 90
#define X_DIR_PIN                           PB5   // pin 89

#define Y_ENABLE_PIN                        PB3   // pin 95
#define Y_STEP_PIN                          PD6   // pin 93
#define Y_DIR_PIN                           PD5   // pin 92

#define Z_ENABLE_PIN                        PD3   // pin 98
#define Z_STEP_PIN                          PD1   // pin 97
#define Z_DIR_PIN                           PD0   // pin 96

#define E0_ENABLE_PIN                       PC14   // pin 3
#define E0_STEP_PIN                         PC13   // pin 2
#define E0_DIR_PIN                          PE6   // pin 1

//
// Temperature Sensors
//
#define TEMP_0_PIN                          PC1   // pin 23 (Nozzle 100K/3950 thermistor)
#define TEMP_BED_PIN                        PC2   // pin 24 (Hot Bed 100K/3950 thermistor)

//
// Heaters / Fans
//
#define HEATER_0_PIN                        PA7   // pin 84 (Nozzle Heat Mosfet)
#define HEATER_BED_PIN                      PA6   // pin 67 (Hot Bed Mosfet)

#define FAN_PIN                             PE13  // pin 77 (4cm Fan)
#ifdef MAPLE_STM32F1
