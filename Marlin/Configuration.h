...
#define EXTRUDE_MAXLENGTH 100000
...
//#define PROBING_HEATERS_OFF       // Turn heaters off when probing
  ...
  //#define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent x extrude)
#endif
 ...
 * LCD Menu Items
 *
 * Disable all menus and only display the Status Screen, 0
